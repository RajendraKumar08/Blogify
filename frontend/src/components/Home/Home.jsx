          ...
          {blogs && blogs.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 px-3">
              ...
              {blogs && (() => {
                ...
                <h5 className="font-bold text-sm text-gray-700">Liked By : {blog.likes?.length || 0} people</h5>
                <h5 className="font-bold text-sm text-gray-700">Comments : {blog.comments?.length || 0}</h5>
